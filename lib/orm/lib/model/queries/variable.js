...
class VariableQueries {
  ...
  static createElement(element, property, type) {
    ...
    // TODO: handle constraints and defaults for value.
    let cols = [
      ['value', typeStr],
      ...
      ['FOREIGN KEY(handle) REFERENCES ' + element + '.handle(value)'],
    ];

    let query = BaseQueries.createTable(element, property, cols)[0];
